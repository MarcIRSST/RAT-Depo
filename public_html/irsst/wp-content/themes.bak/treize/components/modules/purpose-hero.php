...
<section class="hero hero--purpose different-background">
    <div class="wrapper">
        ...
        <div class="hero__text-content">
            <div class="row">
                <h1 class="col-xxl-8 col-xl-12"><?php echo $hero_title; ?></h1>
            </div>
            <div class="row">
                ...
                <?php if ($context) : ?>
                    <div class="hero__context col-xxl-4 col-xxl-offset-7 col-xl-5 col-xl-offset-6 col-lg-12 col-lg-offset-0">
