jQuery(document).ready(function ($) {
    ...
    function addSearchEvents () {
        ...
        $('.modal--search #modal-close').click(toggleSearchModal);
    }
    ...
    function addTagToLastWord () {
        $('.cta--main, .cta--secondary, .cta--external, .menu-pied-de-page-contexte-container li a, .menu-pied-de-page-donnees-container li a, a[target="_blank"]').html(function () {
