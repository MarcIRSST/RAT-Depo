				...
				'advanced'	=> array(
					...
					'groups'	=>	array(
						...
						'lookup'	=>	array(
							...
							'heading'	=>	__('Tracking', 'ws-form'),
							'fields'	=>	array(

								'ip_lookup_method' => array(

									'label'		=>	__('IP Geolocation Service', 'ws-form'),
									'type'		=>	'select',
									'options'	=>	array(

										'' => array('text' => __('geoPlugin', 'ws-form')),
										'ipapi' => array('text' => __('ip-api', 'ws-form')),
									),
									'default'	=>	'',
									'help'		=>	__('Choose which service to use for IP geolocation.', 'ws-form')
								),

								'ip_lookup_geoplugin_key' => array(

									'label'		=>	__('geoPlugin API Key', 'ws-form'),
									'type'		=>	'text',
									'default'	=>	'',
									'help'		=>	sprintf(
										...
										__('If you are using the commercial version of geoPlugin, please enter your API key.', 'ws-form'),
										__('Learn more', 'ws-form')
									)
								),
								...
								'ip_lookup_ipapi_key' => array(
									...
									'label'		=>	__('ip-api API Key', 'ws-form'),
									'type'		=>	'text',
									'default'	=>	'',
									'help'		=>	sprintf(
										...
										__('If you are using the commercial version of ip-api, please enter your API key.', 'ws-form'),
										__('Learn more', 'ws-form')
									)
								),
