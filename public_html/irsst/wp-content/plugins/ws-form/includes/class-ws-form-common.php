<?php
	...
	class WS_Form_Common {
		...
		public static function get_request_timeout() {
			...
			return apply_filters('wsf_api_call_timeout', WS_FORM_API_CALL_TIMEOUT);
		}

		// Get wp_remote_* sslverify
		public static function get_request_sslverify() {

			return apply_filters('wsf_api_call_verify_ssl', WS_FORM_API_CALL_VERIFY_SSL);
		}
